...
<style>
  ...
  #resume-pic {
    ...
    height: 15rem;
    margin: 2.5rem;
    background-image: url('./../../../assets/img/resume1.png');
  ...
  #section1>.h-line {
    margin: 1rem 2.5rem 0rem 21.25rem;
  }
